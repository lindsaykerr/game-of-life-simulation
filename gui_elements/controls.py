...
class AppControls:
    """
    Assigns controls to widgets, and sets basic widget configuration and validation  

    """
    disable_reg = [] # controls list to disabled widgets when sim is running

    def __init__(self, tKinterRoot: tk.Tk) -> None:
        self._root = tKinterRoot
    ...
    def sim_grid_dimX(self, dim_W: tk.Widget, other: tk.Widget, reset_button:tk.Widget):
        """
        ...
        def on_spin():
            for widget in self.disable_reg:
                if not widget in [dim_W, other, reset_button]:
    ...
    def sim_x_pos(self, dim_W:tk.Widget):
        """
    ...
    def sim_y_pos(self, dim_W: tk.Widget):
        """
    ...
    def sim_run(self, run_W: tk.Widget, canvas_sim:CanvasSim, reset_W:tk.Widget):
        """
